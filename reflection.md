...
## testing and quality control: i used pytest to verify that some basic functions of the program were working as required to prevent the code from being developed and released with faults. the tests were focused on saving and loading recipes and they essentially just verified that the two functions were doing their job as required and were not being affected by anything.
